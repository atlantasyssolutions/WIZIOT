...
export default function Footer() {
  const targetLocations = [
    ...
    { city: 'Mombasa', country: 'Kenya', slug: 'mombasa' },
    { city: 'Lagos', country: 'Nigeria', slug: 'lagos' },
    { city: 'Kano', country: 'Nigeria', slug: 'kano' },
    { city: 'Johannesburg', country: 'South Africa', slug: 'johannesburg' },
    { city: 'Durban', country: 'South Africa', slug: 'durban' },
    { city: 'Warsaw', country: 'Poland', slug: 'warsaw' },
    { city: 'Krakow', country: 'Poland', slug: 'krakow' },
    { city: 'Bucharest', country: 'Romania', slug: 'bucharest' },
    { city: 'Constanta', country: 'Romania', slug: 'constanta' },
        ...
        <div className={styles.footerGrid}>
          ...
          <div className={styles.brandCol}>
            ...
            <div style={{ display: 'flex', gap: '12px', marginTop: '12px' }}>
              <a href="https://linkedin.com" target="_blank" rel="noreferrer" className="btn btn-secondary btn-sm" aria-label="LinkedIn" style={{ background: 'rgba(255, 255, 255, 0.1)', color: '#fff', border: 'none' }}>
          ...
          <div>
            ...
            <div className={styles.contactInfo}>
              ...
              <div className={styles.contactRow}>
                ...
                <span>25+ Global Deployments</span>
              </div>
              <div className={styles.contactRow}>

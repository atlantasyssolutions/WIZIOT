        ...
        <div className={styles.footerGrid}>
          ...
          <div className={styles.brandCol}>
            ...
            <div style={{ display: 'flex', gap: '12px', marginTop: '12px' }}>
              <a href="https://www.linkedin.com/company/wiziot-technologies/?viewAsMember=true" target="_blank" rel="noreferrer" className="btn btn-secondary btn-sm" aria-label="LinkedIn" style={{ background: 'rgba(255, 255, 255, 0.1)', color: '#fff', border: 'none' }}>

export const VERTICALS_DATA = [
  {
    ...
    badge: 'Popular',
    icon: 'Truck',
    points: ['Capacitive Fuel Probes (±0.2%)', 'Engine Ignition-Off Siphoning Alarms', 'Remote Engine Cut-Off (R116)'],
    details: 'Comprehensive B2B telematics architecture engineered for commercial transport hauliers. Connects heavy semi-trucks, trailers, and delivery vans with live GPS tracking, ±0.2% capacitive fuel probes, ECU CAN-bus diagnostic monitoring, and automated fuel card reconciliation.',
    features: [
  ...
  },
  {
    ...
    icon: 'Thermometer',
    points: ['Wireless BLE Temp Pods (-80°C)', 'Door Open Vapor Leak Alarms', 'WHO GDP Audit Certificates'],
  ...
  },
  {
    ...
    icon: 'Cpu',
    points: ['Automated Engine Hour Counter', 'Hydraulic Pressure Sensors', 'IP69K Steam Washdown Rated'],
  ...
  },
  {
    ...
    badge: 'Smart City',
    icon: 'Bus',
    points: ['AI Optical Passenger Counter (99%)', 'GTFS-RT Live Feed Engine', 'Automated Audio/LED Announcements'],

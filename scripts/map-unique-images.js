...
const mappings = [
  ...
  // Vertical card images - 7 unique (including school transport)
  ...
  { src: 'img_109_truck_driver_viewing_speed_signs_202608181649_jpeg.webp', dest: 'vert-school.webp' },

  // Solution detail page hero banners - 7 unique
  ...
  { src: 'img_86_transport_vehicle_displaying_tel__2k_202608181650_jpeg.webp', dest: 'sol-school-hero.webp' },

  // Solution detail secondary images - 7 unique
  ...
  { src: 'img_87_transport_vehicle_displaying_tel__2k_202608181651__1__jpeg.webp', dest: 'sol-school-detail.webp' },

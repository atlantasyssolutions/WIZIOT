      ...
      <div className="container" style={{ maxWidth: '880px' }}>
        ...
        <div className="glass-card" style={{ padding: '36px', lineHeight: '1.8', color: 'var(--text-main)', fontSize: '1.05rem', background: '#FFFFFF', border: '1px solid #E2E8F0' }}>
          ...
          <p style={{ marginBottom: '24px' }}>
            The following demonstrates the User Agreement (hereinafter referred to as the "Agreement") between <strong>WizIOT Technologies</strong> (hereinafter referred to as "WizIOT", "we", "us") and the users of the Website and WizIOT telematics platform ("You", "Your", "User"/"Users").
          </p>

          <p style={{ marginBottom: '24px' }}>
            Before you subscribe to and/or begin participating in or using the website and platform, WizIOT believes that user(s) have fully read, understood, and accept the Agreement. If you do not agree to or wish to be bound by this Agreement, you may not access or otherwise use the website or services.
          </p>
          ...
          <p style={{ marginBottom: '24px' }}>
            Your use of the WizIOT website (https://www.wiziot.com) and services available on the website is governed by the following terms and conditions. This User Agreement for the website came into effect on June 3, 2013, with continuous updates for WizIOT cloud services.
          </p>
          ...
          <p style={{ marginBottom: '24px' }}>
            User(s) means any individual or business entity/organization that legally operates in India or in other countries, uses, and has the right to use the services provided by WizIOT. Our services are available only to those individuals or companies who can form legally binding contracts under applicable law. If you are registering as a business entity, you represent that you are duly authorized by the business entity to accept this User Agreement and have authority to bind that entity.
          </p>
          ...
          <p style={{ marginBottom: '24px' }}>
            When You use the Website or send emails or other data/communications to WizIOT, You agree and understand that You are communicating through electronic records and consent to receive communications via electronic records periodically.
          </p>
          ...
          <ul style={{ paddingLeft: '24px', marginBottom: '24px' }}>
            ...
            <li>Threatens the unity, integrity, defense, security or sovereignty of friendly states;</li>
          ...
          <p style={{ marginBottom: '24px' }}>
            User(s) grant a worldwide, sub-licensable license to WizIOT to process operational vehicle telemetry data strictly to render fleet tracking, sensor diagnostics, and analytics services as authorized under your subscription.
          </p>

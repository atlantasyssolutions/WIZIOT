...
export function getAllBlogs() {
  ...
  if (fs.existsSync(blogsDirectory)) {
    ...
    mdBlogs = files.map((file) => {
      ...
      const publishedAt = attributes.publishedAt || '2026-08-18';
...
export function generateArticleSchema(blog) {
  ...
  return {
    ...
    datePublished: blog.publishedAt || '2026-08-18',
    dateModified: blog.publishedAt || '2026-08-18',
    author: {
      '@type': 'Person',
    ...
    keywords: blog.seoKeywords ? blog.seoKeywords.join(', ') : '',
  };
}
